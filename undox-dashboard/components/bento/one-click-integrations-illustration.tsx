...
const OneClickIntegrationsIllustration: React.FC<OneClickIntegrationsIllustrationProps> = ({ className = "" }) => {
  ...
  const LogoBox: React.FC<{
    ...
    const boxStyle: React.CSSProperties = {
      ...
      position: "relative",
      borderRadius: "9px",
      border: `1px ${themeVars["--oci-border-color" as keyof React.CSSProperties]} solid`,
      display: "flex",
    ...
    if (isGradientBg) {
      boxStyle.background = `linear-gradient(180deg, ${themeVars["--oci-gradient-light-gray-start" as keyof React.CSSProperties]} 0%, ${themeVars["--oci-gradient-light-gray-end" as keyof React.CSSProperties]} 100%)`
      boxStyle.boxShadow = `0px 1px 2px ${themeVars["--oci-shadow-color" as keyof React.CSSProperties]}`
      ...
      <div
        style={{
          ...
          background: `radial-gradient(ellipse 103.87% 77.04% at 52.56% -1.80%, 
            ${themeVars["--oci-foreground-color" as keyof React.CSSProperties]}00 0%, 
            ${themeVars["--oci-foreground-color" as keyof React.CSSProperties]}F5 15%, 
            ${themeVars["--oci-foreground-color" as keyof React.CSSProperties]}66 49%, 
            ${themeVars["--oci-foreground-color" as keyof React.CSSProperties]}F5 87%, 
            ${themeVars["--oci-foreground-color" as keyof React.CSSProperties]}00 100%)`,
        }}
      />
